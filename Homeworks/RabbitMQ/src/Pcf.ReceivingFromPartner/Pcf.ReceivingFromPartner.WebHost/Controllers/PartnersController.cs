...
namespace Pcf.ReceivingFromPartner.WebHost.Controllers
{
        ...
        : ControllerBase
    {
            ...
            ReceivingPromoCodeRequest request)
        {
            ...
            await _publishEndpoint.Publish(new PromoCodeReceived(
                promoCode.Id, partner.Id, promoCode.Code, promoCode.ServiceInfo,
                promoCode.PreferenceId, promoCode.BeginDate, promoCode.EndDate,
